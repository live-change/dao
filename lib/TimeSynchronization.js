class TimeSynchronization {
  ...
  handleTimeSync(clientTs, serverTs) {
    ...
    if(this.phases.length > this.nextPhaseId) {
      ...
      if(this.pongCount >= phase.afterPongCount) {
        ...
        this.maxSendInterval = phase.maxPingInterval || 10000
      }
    }
  }
  ...
  run() {
    ...
    console.log("PC", this.pongCount, interval, this.sendInterval, this.sendIntervalIncrement, this.maxSendInterval)
