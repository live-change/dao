...
class Connection extends EventEmitter {
  ...
  sendRequest(msg, settings) {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (!this.connected) {
        if(settings.disconnectDebug) console.error("SEND REQUEST", msg, "WHEN NOT CONNECTED WITH SETTINGS", settings)
  ...
  handleDisconnect() {
    ...
    for(const req of this.waitingRequests.values()) {
      console.error("SENT REQUEST", req.msg, "BEFORE DISCONNECTED WITH SETTINGS", settings)
