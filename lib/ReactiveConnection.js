...
class Connection extends EventEmitter {
  ...
  sendObserve(observation) {
    ...
    if(remoteObserves) {
      console.error("Observe duplication! existing observations", remoteObserves, 'new observation', observation)
    } else {
      remoteObserves = []
  ...
  sendUnobserve(observation) {
    ...
    if(remoteUnobserves) {
      console.error("Observe duplication! removed observations", remoteUnobserves, 'next observation', observation)
    } else {
      remoteUnobserves = []
